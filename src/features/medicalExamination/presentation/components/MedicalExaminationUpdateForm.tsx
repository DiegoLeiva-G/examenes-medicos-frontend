...
export interface IMedicalExaminationUpdateFormValues {
...
interface IMedicalExaminationUpdateFormProps {
  medicalExamination?: MedicalExaminationGetAllResponseEntity | null;
  loading?: boolean;
  onSubmitData: (values: IMedicalExaminationUpdateFormValues) => void;
  medicalPatients: MedicalPatientEntity[];
  medicalExaminationTypes: MedicalExaminationTypeEntity[];
  doctors: DoctorEntity[];
}

export const MedicalExaminationUpdateForm: FC<IMedicalExaminationUpdateFormProps> = ({
  onSubmitData,
  medicalExamination,
  loading,
  medicalPatients,
  ...
  const getVisibleFields = () => {
    if (!selectedType && !medicalExamination) {
      return [];
    }

    const fields = [];

    if (medicalExamination?.observation) fields.push('observation');
    if (medicalExamination?.observation2) fields.push('observation2');
    if (medicalExamination?.dimension) fields.push('dimension');
    if (medicalExamination?.dimension2) fields.push('dimension2');
    if (medicalExamination?.descriptionDimension) fields.push('descriptionDimension');
    if (medicalExamination?.anexes) fields.push('anexes');
    if (medicalExamination?.anexes2) fields.push('anexes2');
    if (medicalExamination?.descriptionAnexes) fields.push('descriptionAnexes');
    if (medicalExamination?.conclusion) fields.push('conclusion');

    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (observationEditorRef.current?.getContent()) fields.push('observation');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (observation2EditorRef.current?.getContent()) fields.push('observation2');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (dimensionEditorRef.current?.getContent()) fields.push('dimension');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (dimension2EditorRef.current?.getContent()) fields.push('dimension2');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (descriptionDimensionEditorRef.current?.getContent()) fields.push('descriptionDimension');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (anexesEditorRef.current?.getContent()) fields.push('anexes');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (anexes2EditorRef.current?.getContent()) fields.push('anexes2');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (descriptionAnexesEditorRef.current?.getContent()) fields.push('descriptionAnexes');
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-expect-error
    if (conclusionEditorRef.current?.getContent()) fields.push('conclusion');
  ...
  useEffect(() => {
    if (medicalExamination && !isInitialized) {
      if (observationEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        observationEditorRef.current.setContent(medicalExamination.observation || '');
      }
      if (observation2EditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        observation2EditorRef.current.setContent(medicalExamination.observation2 || '');
      }
      if (dimensionEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        dimensionEditorRef.current.setContent(medicalExamination.dimension || '');
      }
      if (dimension2EditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        dimension2EditorRef.current.setContent(medicalExamination.dimension2 || '');
      }
      if (descriptionDimensionEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        descriptionDimensionEditorRef.current.setContent(medicalExamination.descriptionDimension || '');
      }
      if (anexesEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        anexesEditorRef.current.setContent(medicalExamination.anexes || '');
      }
      if (anexes2EditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        anexes2EditorRef.current.setContent(medicalExamination.anexes2 || '');
      }
      if (descriptionAnexesEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        descriptionAnexesEditorRef.current.setContent(medicalExamination.descriptionAnexes || '');
      }
      if (conclusionEditorRef.current) {
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-expect-error
        conclusionEditorRef.current.setContent(medicalExamination.conclusion || '');
      }
  ...
  return (
    <Form
      ...
      onSubmitCapture={event => {
        ...
        form
          .validateFields()
          .then((values: IMedicalExaminationUpdateFormValues) => {
            onSubmitData({
              ...values,
              // eslint-disable-next-line @typescript-eslint/ban-ts-comment
              // @ts-expect-error
    ...
    >
      ...
      {getVisibleFields().includes('observation') && (
        <Row spacingX="sm:gap-x-6">
      ...
      {getVisibleFields().includes('observation2') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {/* Dimensiones */}
      {getVisibleFields().includes('dimension') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {getVisibleFields().includes('dimension2') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {getVisibleFields().includes('descriptionDimension') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {/* Anexos */}
      {getVisibleFields().includes('anexes') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {getVisibleFields().includes('anexes2') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {getVisibleFields().includes('descriptionAnexes') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
      ...
      {getVisibleFields().includes('conclusion') && (
        <Row spacingX="sm:gap-x-6">
          <Column colSpan="col-span-full">
