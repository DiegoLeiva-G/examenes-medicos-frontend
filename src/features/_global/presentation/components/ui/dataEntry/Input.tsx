...
const Input: FC<IInputProps> = ({ id, label, error, errorMessages, required, type = 'text', ...leftProps }) => {
  return (
    <div className="pb-3" style={{ height: 88 }}>
      ...
      <div className="relative mt-2 rounded-md shadow-sm">
        <input
          ...
          } sm:text-sm sm:leading-6 dark:bg-gray-700 dark:text-white disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 disabled:ring-gray-200 dark:disabled:bg-gray-900 dark:disabled:text-gray-400 dark:disabled:ring-gray-700`}
        />
        {error && (
